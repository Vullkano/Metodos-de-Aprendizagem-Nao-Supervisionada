...
```{r}
options(repos = "https://cran.radicaldevelop.com/", repr.plot.width=6, repr.plot.height=6,scipen = 999)
...
pacman::p_load(
               ...
               "haven", "magrittr", "mice", 
               "here", "conflicted","arrow"
)
here::i_am("mans.Rproj")
...
```{r}
IrlandaImputInc <- arrow::read_csv_arrow(here("data", "IrlandaImput.csv"))
```
...
=======
>>>>>>> 1815b8e85d2f32d1e42803d2bf469da5d54213b4
